...
a = Analysis(['user_sync/app.py'],
             ...
             datas=[
                    ...
                    ('user_sync/resources/examples/config files - basic/*', 'resources/examples'),
                    ('user_sync/resources/examples/config files - custom attributes and mappings/*', 'resources/examples'),
                    ('user_sync/resources/examples/sign/*', 'resources/examples'),
